...
<template>
    <button>
        ...
        <!-- <svg :class="[toggled ? 'rotated' : '', hd ? 'hd' : '']" height="100%" version="1.1" viewBox="0 0 36 36" -->
        <svg :class="{ 'rotated': toggled === true, 'hd': hd === true }" height="100%" version="1.1" viewBox="0 0 36 36"
            width="100%">
            <path
